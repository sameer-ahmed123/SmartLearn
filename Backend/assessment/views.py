...
def submit_assignment(request, assignment_id):
    ...
    try:
        ...
        # 🔥 Plagiarism fields output ke response mein add kiye hain taake frontend read kar sake
        return Response({
...
def assignment_detail_update(request, assignment_id):
    ...
    if request.method == 'GET':
        ...
        # 🔥 Yahan user_submission block ke andar plagiarism ke dono fields pass kar diye hain
