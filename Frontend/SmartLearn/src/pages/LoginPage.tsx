...
// Sahi relative path use kar rahe hain takay Vite error na de
...
export default function LoginPage() {
  ...
  // Default Language Setup (TopBar ke mutabiq)
  ...
  // Outside click par menu band karne ke liye
  useEffect(() => {
  ...
  // Translation Logic (TopBar se li gayi)
